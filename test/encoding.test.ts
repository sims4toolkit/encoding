 ...
 * 
 * For your own assurance that these classes are functioning, you can check out
 * a demo at https://frankkmods.com/#/ts4-tools/stbl-editor, where they are
 * used to serialize and deserialize String Tables.
 */